...
namespace Eventer.Areas.Identity.Pages.Account.Manage
{
    // Usunięcie [AllowAnonymous], ponieważ ten plik powinien wymagać logowania
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Link potwierdzający zmianę emaila został wysłany. Sprawdź swoją skrzynkę.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Email weryfikacyjny został wysłany. Sprawdź swoją skrzynkę.";
            return RedirectToPage();
        }
    }
}