...
namespace Eventer.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Nie można utworzyć instancji '{nameof(IdentityUser)}'. " +
                    $"Upewnij się, że '{nameof(IdentityUser)}' nie jest klasą abstrakcyjną i posiada konstruktor bezparametryczny, " +
                    $"lub nadpisz stronę rejestracji w /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("Domyślny interfejs użytkownika wymaga magazynu użytkowników z obsługą wiadomości e-mail.");
            }
